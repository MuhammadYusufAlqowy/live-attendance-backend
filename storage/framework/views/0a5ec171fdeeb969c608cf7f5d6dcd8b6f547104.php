    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo e(Request::is('dashboard') ? 'active' : ''); ?>">
                <a class="nav-link"
                    href="<?php echo e(url('dashboard')); ?>"><i class="fas fa-fire"></i> <span>Dashboard</span></a>
            </li>
            <?php if(Auth::user()->is_admin): ?>
            <li class="nav-item dropdown <?php echo e(Request::is('user*') ? 'active' : ''); ?>">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-user"></i><span>User</span></a>
                <ul class="dropdown-menu">
                    <li class="<?php echo e(Request::is('user') ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(url('user')); ?>">Data User</a>
                    </li>
                    <li class="<?php echo e(Request::is('user/create') ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(url('user/create')); ?>">Add User</a>
                    </li>
                </ul>
            </li>
            <li class="<?php echo e(Request::is('absensi*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('absensi')); ?>"><i class="fas fa-user-check"></i> <span>Absensi</span></a>
            </li>
            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\attendance-api\resources\views/components/sidebar.blade.php ENDPATH**/ ?>