                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                ...
                                                <figure class="imagecheck-figure">
                                                    <img src="<?php echo e(asset('img/news/img01.jpg')); ?>"
                                                        alt="}"
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    checked />
                                                <figure class="imagecheck-figure">
                                                    <img src="<?php echo e(asset('img/news/img02.jpg')); ?>"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    class="imagecheck-input" />
                                                <figure class="imagecheck-figure">
                                                    <img src="<?php echo e(asset('img/news/img03.jpg')); ?>"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    checked />
                                                <figure class="imagecheck-figure">
                                                    <img src="<?php echo e(asset('img/news/img04.jpg')); ?>"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    class="imagecheck-input" />
                                                <figure class="imagecheck-figure">
                                                    <img src="<?php echo e(asset('img/news/img05.jpg')); ?>"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    class="imagecheck-input" />
                                                <figure class="imagecheck-figure">
                                                    <img src="<?php echo e(asset('img/news/img06.jpg')); ?>"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\attendance-api\resources\views/pages/forms-advanced-form.blade.php ENDPATH**/ ?>