<?php $__env->startSection('title', 'Avatar'); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <figure class="avatar avatar-xl mr-2">
                                    <img src="<?php echo e(asset('img/avatar/avatar-1.png')); ?>"
                                        alt="...">
                                </figure>
                                <figure class="avatar avatar-lg mr-2">
                                    <img src="<?php echo e(asset('img/avatar/avatar-2.png')); ?>"
                                        alt="...">
                                </figure>
                                <figure class="avatar mr-2">
                                    <img src="<?php echo e(asset('img/avatar/avatar-5.png')); ?>"
                                        alt="...">
                                </figure>
                                ...
                                <figure class="avatar avatar-xs mr-2">
                                    <img src="<?php echo e(asset('img/avatar/avatar-4.png')); ?>"
                                        alt="...">
                                </figure>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\attendance-api\resources\views/pages/components-avatar.blade.php ENDPATH**/ ?>